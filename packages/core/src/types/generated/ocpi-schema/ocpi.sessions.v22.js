...
exports.Session = zod_1.z.object({
    ...
    cdr_token: ocpi_cdrs_v22_1.CdrToken,
    auth_method: ocpi_cdrs_v22_1.AuthMethod,
    ...
    charging_periods: zod_1.z.array(ocpi_cdrs_v22_1.ChargingPeriod).nullish(),
    total_cost: ocpi_common_v22_1.Price.nullish(),
    status: exports.SessionStatus,
    last_updated: zod_1.z.date(),
});
exports.Sessions = zod_1.z.array(exports.Session);
//# sourceMappingURL=ocpi.sessions.v22.js.map