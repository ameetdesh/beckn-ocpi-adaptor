import { z } from "zod";
export declare const AuthMethod: z.ZodEnum<["AUTH_REQUEST", "WHITELIST"]>;
export declare const ChargingPeriod: z.ZodObject<{
    start_date_time: z.ZodDate;
    dimensions: z.ZodArray<z.ZodObject<{
        type: z.ZodEnum<["ENERGY", "FLAT", "MAX_CURRENT", "MIN_CURRENT", "PARKING_TIME", "TIME"]>;
        volume: z.ZodNumber;
    }, "strip", z.ZodTypeAny, {
        type: "ENERGY" | "FLAT" | "PARKING_TIME" | "TIME" | "MAX_CURRENT" | "MIN_CURRENT";
        volume: number;
    }, {
        type: "ENERGY" | "FLAT" | "PARKING_TIME" | "TIME" | "MAX_CURRENT" | "MIN_CURRENT";
        volume: number;
...
export declare const SessionLocation: z.ZodObject<{
    id: z.ZodString;
...
export declare const Session: z.ZodObject<{
    id: z.ZodString;
    start_datetime: z.ZodDate;
    end_datetime: z.ZodOptional<z.ZodNullable<z.ZodDate>>;
    kwh: z.ZodNumber;
    auth_id: z.ZodString;
    auth_method: z.ZodEnum<["AUTH_REQUEST", "WHITELIST"]>;
    ...
    status: z.ZodEnum<["ACTIVE", "COMPLETED", "INVALID", "PENDING"]>;
    last_updated: z.ZodDate;
}, "strip", z.ZodTypeAny, {
    status: "PENDING" | "COMPLETED" | "ACTIVE" | "INVALID";
    id: string;
    location: {
        type: "OTHER" | "UNKNOWN" | "ON_STREET" | "PARKING_GARAGE" | "UNDERGROUND_GARAGE" | "PARKING_LOT";
        address: string;
    ...
    end_datetime?: Date | null | undefined;
...
//# sourceMappingURL=ocpi.session.d.ts.map