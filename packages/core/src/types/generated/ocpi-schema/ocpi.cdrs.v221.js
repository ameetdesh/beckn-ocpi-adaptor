...
const ocpi_common_v221_2 = require("./ocpi.common.v221");
...
exports.CdrToken = zod_1.z.object({
    ...
    country_code: zod_1.z.string().max(2),
...
exports.CdrLocation = zod_1.z.object({
    ...
    coordinates: ocpi_location_v221_1.GeoLocation,
    ...
    connector_standard: ocpi_location_v221_1.ConnectorType,
    connector_format: ocpi_location_v221_1.ConnectorFormat,
    connector_power_type: ocpi_location_v221_1.PowerType,
});
...
exports.SignedValue = zod_1.z.object({
    ...
    signed_data: zod_1.z.string().max(5000)
});
...
exports.Cdr = zod_1.z.object({
    ...
    tariffs: zod_1.z.array(ocpi_tariff_v221_1.Tariff).nullish(),
    charging_periods: zod_1.z.array(exports.ChargingPeriod).nonempty(),
    signed_data: exports.SignedData.nullish(),
    total_cost: ocpi_common_v221_2.Price,
    total_fixed_cost: ocpi_common_v221_2.Price.nullish(),
    total_energy: zod_1.z.number().nonnegative(),
    total_energy_cost: ocpi_common_v221_2.Price.nullish(),
    total_time: zod_1.z.number().nonnegative(),
    total_time_cost: ocpi_common_v221_2.Price.nullish(),
    total_parking_time: zod_1.z.number().nonnegative().nullish(),
    total_parking_cost: ocpi_common_v221_2.Price.nullish(),
    total_reservation_cost: ocpi_common_v221_2.Price.nullish(),
    ...
    home_charging_compensation: zod_1.z.boolean().nullish(),
    last_updated: zod_1.z.date(),
});
exports.Cdrs = zod_1.z.array(exports.Cdr);
//# sourceMappingURL=ocpi.cdrs.v221.js.map